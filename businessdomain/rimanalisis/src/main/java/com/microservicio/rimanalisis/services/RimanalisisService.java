...
public interface RimanalisisService {
   ...
   // ► Repository `ProduccionAnalisis` method's ...
   void saveProduccionAnalisis(ProduccionAnalisis produccionAnalisis);
   ProduccionAnalisis findProduccionAnalisisById(Long idProdAnalisis);
   void setTerminadoProduccionAnalisis(Long idProdAnalisis);
